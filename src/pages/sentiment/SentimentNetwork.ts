  ...
  return h('div', null,
    ...
    h('div', {
      ...
      h('label', { style: checkboxStyle },
        h('input', { type: 'checkbox', checked: showPres, onChange: () => setShowPres(!showPres), 'aria-label': 'Show presidents' }),
        ' Presidents',
      ),
      h('label', { style: checkboxStyle },
        h('input', { type: 'checkbox', checked: showLeg, onChange: () => setShowLeg(!showLeg), 'aria-label': 'Show legislation' }),
        ' Legislation',
      ),
      h('label', { style: checkboxStyle },
        h('input', { type: 'checkbox', checked: showEvt, onChange: () => setShowEvt(!showEvt), 'aria-label': 'Show events' }),
        ' Events',
      ),
      h('label', { style: checkboxStyle },
        h('input', { type: 'checkbox', checked: showCross, onChange: () => setShowCross(!showCross), 'aria-label': 'Show cross-term support and opposition' }),
